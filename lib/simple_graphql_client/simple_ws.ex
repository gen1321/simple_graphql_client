defmodule SimpleGraphqlClient.SimpleWs do
  use WebSockex
  require Logger

  def start_link(opts \\ []) do
    WebSockex.start_link("ws://localhost:4000/socket/websocket", __MODULE__, :fake_state, opts)
  end
...
# {:ok, pid} = SimpleWs.start_link()

# v = %{topic: "__absinthe__:control", event: "phx_join", payload: %{}, ref: "1"} |> Poison.encode!()
# SimpleWs.echo(pid, v)
